...
const Product = (props) => {
    ...
    return (
        ...
        <div className="product">
             ...
             */}
            <button className="addToCardButton" onClick={()=>addToCart(id, props.keyLocation)}>Add To Cart {cartItemAmount > 0 && <React.Fragment>({cartItemAmount})</React.Fragment>}</button>
        </div>
    )
}
